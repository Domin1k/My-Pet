    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdoptionCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdoptionAds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdoptionAds_AdoptionCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "AdoptionCategories",
                        principalColumn: "Id",
